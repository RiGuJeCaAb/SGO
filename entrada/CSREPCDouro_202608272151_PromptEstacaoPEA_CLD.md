...
Ponto de trânsito: `O.dados.pt = { des, resp, ct, cd, obs }`, com acessor `ptObj()` e sugestão
automática a partir da carta (`sugerirPT`, Overpass, candidatos entre 1,5 e 8 km do TO:
quartéis, parques, zonas industriais, áreas de serviço, campos de jogos).
