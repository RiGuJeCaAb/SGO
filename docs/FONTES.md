...
|---|---|
| `Modelos_de_combustivel_florestal_para_Portugal_Fernandes_Loureiro_2021.pdf` | Os 18 modelos de `MODELOS_COMB` estão por confrontar com esta fonte desde que entraram. Chegou uma segunda cópia a 4 de setembro, byte a byte igual à de 2 de setembro que a `FOGOPT` já cita: ficou a primeira, e só ela |
