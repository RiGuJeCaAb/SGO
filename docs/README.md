...
| Ficheiro | Estado |
|---|---|
| `CSREPCDouro_202608271715_EspecificacaoExportacaoJSON_CLD.md` | **Em vigor.** É o que a Gestão PCO deve implementar |
| `CSREPCDouro_202608281700_EspecificacaoExportacaoJSON_v12_PROPOSTA_CLD.md` | Proposta de v1.2, por decidir |
| `CSREPCDouro_d0002_202608281630_ContratoGestaoPCO_CLD.md` | Arquivado. Escrito a analisar um esboço anterior; o seu autor corrigiu-se |
